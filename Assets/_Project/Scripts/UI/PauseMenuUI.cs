...
public class PauseMenuUI : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (UserInterfaceManager.Instance != null) UserInterfaceManager.Instance.RegisterPanel(UserInterfaceManager.PanelType.Pause, () => TogglePause(true));
    }

    void Update()
    {
        if (InputManager.Instance != null && Input.GetKeyDown(KeyCode.Escape))
        {
    ...
    {
        if (UserInterfaceManager.Instance != null) UserInterfaceManager.Instance.ReportClosedPanel(UserInterfaceManager.PanelType.Pause);
        TogglePause(false);
    }
    ...
    void OnDestroy()
    {
        ...
        if (backFromSettingsButton != null) quitButton.onClick.RemoveAllListeners();
